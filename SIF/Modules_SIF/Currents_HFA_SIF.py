...
def calc_bound_integrand_current(Hamiltonian0 ,U,n_list,
    ...
    integrand_lower = abs( np.round( negf_method.integrand_current_HFA(e_lower,
    ...
    integrand_upper = abs( np.round( negf_method.integrand_current_HFA(e_upper,
                                 Hamiltonian0 ,U,n_list,
                                    epsilon0L,tleadL,tcoupL,matL,
                                    epsilon0R,tleadR,tcoupR,matR,
                                      pz,
    ...
    while integrand_upper != 0:
        ...
        integrand_upper = abs( 
                        np.round( 
                               negf_HIA_git.integrand_current_HFA(e_upper,
                                 Hamiltonian0 ,U,n_list,
                                    epsilon0L,tleadL,tcoupL,matL,
                                    epsilon0R,tleadR,tcoupR,matR,
                                      pz,
...
def calc_I_trapz(npoints_int,
    ...
    for i in range(len(V_list)):
        ...
        Tbar_list = [ negf_method.integrand_current_HFA(energy,
                                 Hamiltonian0 ,U,n_list,
                                    epsilon0L,tleadL,tcoupL,matL,
                                    epsilon0R,tleadR,tcoupR,matR,
                                      pz,
...
def calc_I_trapz_VoltDepLeads(npoints_int,
                V_list,ef,
              Hamiltonian0,
              tleadL,tcoupL,matL,
             tleadR,tcoupR,matR,
    ...
    - betaL, betaR = beta =1/kBT of left, right lead
    Output:
    Ilist = list of currents for voltage V, epsilon0L,epsilon0R = muL, muR
    '''
